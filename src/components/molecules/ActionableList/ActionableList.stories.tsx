...
const meta: Meta<IActionableListProps> = {
    ...
    argTypes: {
        ...
        managedSelection: args({ control: "false", defaultValue: false, ...propCategory.others }),
        onCrossListDrop: args({ control: "false", action: "onCrossListDrop", ...propCategory.action }),
