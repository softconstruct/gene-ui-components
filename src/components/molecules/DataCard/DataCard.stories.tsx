...
const nestedActions: IMenuItemProps[] = [
    {
        id: "1",
        title: "Edit",
        IconAfter: DocumentPen,
        children: [
            { id: "1-1", title: "Edit Profile" },
            { id: "1-2", title: "Edit Settings" }
        ]
    },
    { id: "2", title: "Delete", IconAfter: RecycleBin, danger: true }
];
...
export const WithNestedMenu: Story = {
    render: (props) => <DataCardStory {...props} actions={nestedActions} />
};
