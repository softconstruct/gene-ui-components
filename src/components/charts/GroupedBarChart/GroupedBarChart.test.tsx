...
describe("GroupedBarChart", () => {
    ...
    const mountGroupedBarChart = (props = {}) =>
        mount(<GroupedBarChart categories={categories} series={series} {...props} />, {
            wrappingComponent: GeneUIProvider
        });

    it("renders without crashing", () => {
        const wrapper = mountGroupedBarChart();
        expect(wrapper.exists()).toBeTruthy();
        expect(wrapper.find(".highcharts-react-mock").exists()).toBeTruthy();
    });

    it("renders loading state", () => {
        const wrapper = mountGroupedBarChart({ loading: true, loadingText: "Loading Info" });
