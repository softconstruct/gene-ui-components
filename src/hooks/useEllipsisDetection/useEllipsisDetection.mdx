...
-   **`externalDependencies`** _(optional)_: An array of dependencies to watch for changes that might affect the ellipsis
...
import { useEllipsisDetection } from '@geneui/hooks';
