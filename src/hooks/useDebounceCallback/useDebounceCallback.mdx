...
<div style={{ paddingInlineStart: '20px' }}>
    ...
    - **`wait`** _(optional)_: The delay time in milliseconds before the callback function is invoked. If not provided, the default is typically a short delay, but you can set it as per your needs.
